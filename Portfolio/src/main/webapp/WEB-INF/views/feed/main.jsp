	...
	<div class="col-lg-12">
		...
		<div class="d-flex justify-content-end mb-3">
			<button type="button" id="create" class="btn btn-primary"
				data-toggle="collapse" title="게시물 생성" data-target="#register" aria-expanded="false"
				...
				<form role="form" id="regForm" action="/feed/register" method="post">
					...
					<div class="card-body">
						...
						<div class="collapse" id="imageDiv">
							<input type="file" multiple="multiple" id="image">
		...
		<c:if test="${empty feed}">
			<div class="card h-100">
				...
				<div class="card-body d-flex justify-content-center">게시물 없음</div>
				...
				<div class="card-header d-flex justify-content-between">
					...
					<div class="dropdown dropleft">
						<button type="button" class="btn btn-secondary dropdown-toggle"
							data-toggle="dropdown" title="게시물에 대한 설정"></button>
				...
				<div class="card-footer">
					<div>
						<div class="d-flex justify-content-between mb-3">
							...
							<button class="btn btn-warning " data-fno="${feed.fno }"
								data-toggle="modal" data-target="#replyModal_${feed.fno }"
								aria-expanded="false" aria-controls="directReply">댓글 등록</button>
						</div>
						<div class="modal fade replyModal" id="replyModal_${feed.fno }"
							tabindex="-1" role="dialog" aria-labelledby="replyModalLabel"
							aria-hidden="true">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										<div class="form-group">
											<label for="recipient-name" class="col-form-label">Who:</label>
									...
									<div class="modal-footer">
										...
										<button type="button" class="btn btn-primary replyRegBtn"
											data-fno="${feed.fno }">Submit</button>
									</div>
								</div>
							</div>
						</div>
					...
					<ul class="chat"></ul>
					<a class="float-right" href="/feed/get?fno=${feed.fno }">more</a>
				</div>
			</div>
		</c:forEach>
...
<script type="text/javascript">
	...
	function checkModal(result) {
		...
		if (result === 'success_modify') {
			$("#alarmModal .modal-body").html("피드가 정상적으로 수정되었습니다.");
			$("#allow").hide();
		}
		if (result === 'success_remove') {
			$("#alarmModal .modal-body").html("피드가 정상적으로 삭제되었습니다.");
			$("#allow").hide();
		}
		if (parseInt(result) > 0) {
			$("#alarmModal .modal-body").html("피드가 정상적으로 등록되었습니다.");
			$("#allow").hide();
		}
		$("#alarmModal").modal("show");
	}
													...
													.getJSON(
															...
															function(arr) {
																var str = "<div id='carouselFadeImage_" 
																		+ index 
																		+ "' class='carousel slide carousel-fade' data-ride=''><div class='carousel-inner'>";
