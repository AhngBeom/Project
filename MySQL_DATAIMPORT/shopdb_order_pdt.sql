...
DROP TABLE IF EXISTS `order_pdt`;
...
CREATE TABLE `order_pdt` (
  ...
  KEY `fk_order_pdt_ordernumber` (`order_number`),
  KEY `fk_order_pdt_pno` (`pno`),
...
LOCK TABLES `order_pdt` WRITE;
/*!40000 ALTER TABLE `order_pdt` DISABLE KEYS */;
/*!40000 ALTER TABLE `order_pdt` ENABLE KEYS */;
UNLOCK TABLES;
