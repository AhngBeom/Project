...
--
-- Table structure for table `pdtorder`
--

DROP TABLE IF EXISTS `pdtorder`;
...
--
-- Dumping data for table `pdtorder`
--

LOCK TABLES `pdtorder` WRITE;
/*!40000 ALTER TABLE `pdtorder` DISABLE KEYS */;
/*!40000 ALTER TABLE `pdtorder` ENABLE KEYS */;
UNLOCK TABLES;
