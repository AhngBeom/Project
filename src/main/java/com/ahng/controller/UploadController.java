...
public class UploadController {
	...
	public void uploadFormPost(MultipartFile[] uploadFile, Model model) {
		...
		String uploadFolder = "C:\\SpringProject\\OnlineShop\\upload";
...
//		log.info("File : " + file);
	...
	public ResponseEntity<Resource> downloadFile(@RequestHeader("User-Agent") String userAgent, String fileName) {
		Resource resource = new FileSystemResource("C:\\SpringProject\\OnlineShop\\upload\\" + fileName);
	...
	public ResponseEntity<String> deleteFile(String fileName, String type) {
		...
		try {
			file = new File("C:\\SpringProject\\OnlineShop\\upload\\" + URLDecoder.decode(fileName, "UTF-8"));
			file.delete();
