									...
									<form action="/auth/register" method="post">
											...
											<div class="col-md-12">
												<div class="form-group">
													<label class="small mb-1" for="inputName">Name</label><input
														class="form-control py-4" id="inputName" name="userName"
										...
										<div class="form-group">
											<label class="small mb-1" for="inputID">ID</label><input
												class="form-control py-4" id="inputID" name="userid"
											...
											<div class="col-md-6">
												<div class="form-group">
													<label class="small mb-1" for="inputPassword">Password</label><input
														class="form-control py-4" id="inputPassword" name="userpw"
										...
										<!-- 										<div class="form-group"> -->
										<!-- 											<label class="small mb-1" for="inputAddress">Address</label><input -->
										<!-- 												class="form-control py-4" id="inputAddress" type="email" -->
